...
class LSMessage : public Header
  ...
  public:
    ...
    /**
     *  \brief Sets HelloReq destinationAddress params
     */

    void SetHelloReq(Ipv4Address destinationAddress);
    ...
    /**
     *  \brief Sets HelloRsp destinationAddress params
     */
    void SetHelloRsp(Ipv4Address destinationAddress);

    /**
     * \returns LSFlood Struct
     */
    LSFlood GetLSFlood();
    /**
     *  \brief Sets LSFlood destinationAddress, neighbours params
     */
    void SetLSFlood(Ipv4Address destinationAddress, Ipv4Address sourceAddress, std::vector<Ipv4Address> neighbours);
  }; // class LSMessage
